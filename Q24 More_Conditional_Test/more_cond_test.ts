...
console.log(('Annu' as string) != 'Ali')//youtube ka tareeqa
...
console.log((10 as number) != 5)//youtube se inequality test
...
//Test whether an item is in a array
let myFriends :string[] = ['Abid', 'Hasnain', 'Raza']
